...
.config(['$routeProvider',
    ...
    $routeProvider
      ...
      .when('/BpBnsPtnrs/show/:ptnrNbr',{templateUrl:'views/BpBnsPtnr/BpBnsPtnrShow.html',controller:'bpBnsPtnrShowCtlr'})
      .when('/BpBnsPtnrs/edit/:ptnrNbr',{templateUrl:'views/BpBnsPtnr/BpBnsPtnrEdit.html',controller:'bpBnsPtnrEditCtlr'});
}])
