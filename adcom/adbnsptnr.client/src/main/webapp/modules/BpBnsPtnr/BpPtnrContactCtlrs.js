...
.controller('bpPtnrContactsCtlr',['$scope','bpPtnrContactResource','$modal','$routeParams','bpPtnrContactUtils',
                                        function($scope,bpPtnrContactResource,$modal,$routeParams,bpPtnrContactUtils){
    ...
    function findByLike(searchInput){
    	...
    	bpPtnrContactResource.findByLike(searchInput)
        ...
        function ModalInstanceCreateCtrl($scope, $modalInstance,bpPtnrContactUtils) {
            ...
            $scope.save = function () {
            	...
            	bpPtnrContactResource.create($scope.bpPtnrContact).success(function () {
                    init();
                });
        ...
        function ModalInstanceEditCtrl($scope, $modalInstance,bpPtnrContact,$timeout,bpPtnrContactUtils) {
            ...
            $scope.save = function () {
                $scope.bpPtnrContact.ptnrNbr = self.ptnrNbr;
            	bpPtnrContactResource.update($scope.bpPtnrContact).success(function(){
                   init();
                });
                $modalInstance.dismiss('cancel');
            };
        ...
        function deleteItem(index){
            handleSelectedItem();
            bpPtnrContactResource.deleteById(self.selectedItem.id).success(function(){
                init();
            })
        }
