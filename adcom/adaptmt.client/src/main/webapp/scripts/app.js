...
angular.module('adaptmt',['ngRoute',
  ...
  .config(['$routeProvider', '$httpProvider','$translateProvider','$translatePartialLoaderProvider', function($routeProvider,$httpProvider,$translateProvider,$translatePartialLoaderProvider) {
    $routeProvider
      ...
      .when('/aptaptmt/show/:id',{templateUrl:'views/aptaptmt/show.html',controller:'aptAptmtShowController'})
      .when('/aptaptmt/update/:id',{templateUrl:'views/aptaptmt/update.html',controller:'aptAptmtUpdateController'})
      .otherwise({
        redirectTo: '/'
      });
