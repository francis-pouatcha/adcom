...
.controller('prcmtDeliveryCreateCtlr',['$scope','prcmtDeliveryResource',function($scope,prcmtDeliveryResource){
	var self = this ;
...
.controller('prcmtDeliveryShowCtlr',['$scope','prcmtDeliveryResource','$routeParams','$location',function($scope,prcmtDeliveryResource,$routeParams,$location){
    var self = this ;
