...
public class BpPtnrCtgryDtlsEJB 
{
   ...
   public List<BpPtnrCtgryDtls> findBy(BpPtnrCtgryDtls entity, int start, int max, SingularAttribute<BpPtnrCtgryDtls, ?>[] attributes)
   {
      return repository.findBy(entity, start, max, attributes);
   }

   public Long countBy(BpPtnrCtgryDtls entity, SingularAttribute<BpPtnrCtgryDtls, ?>[] attributes)
   {
      return repository.count(entity, attributes);
   }

   public List<BpPtnrCtgryDtls> findByLike(BpPtnrCtgryDtls entity, int start, int max, SingularAttribute<BpPtnrCtgryDtls, ?>[] attributes)
   {
      return repository.findByLike(entity, start, max, attributes);
   }

   public Long countByLike(BpPtnrCtgryDtls entity, SingularAttribute<BpPtnrCtgryDtls, ?>[] attributes)
   {
   ...
   public BpPtnrCtgryDtls findByIdentif(String identif, Date validOn){
	   List<BpPtnrCtgryDtls> resultList = repository.findByIdentif(identif, validOn).orderAsc("validFrom").maxResults(1).getResultList();
