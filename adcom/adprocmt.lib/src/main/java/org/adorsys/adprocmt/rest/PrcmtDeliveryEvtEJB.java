...
public class PrcmtDeliveryEvtEJB {
	...
	public List<PrcmtDeliveryEvt> findBy(PrcmtDeliveryEvt entity, int start,
			int max, SingularAttribute<PrcmtDeliveryEvt, ?>[] attributes) {
		return repository.findBy(entity, start, max, attributes);
	}

	public Long countBy(PrcmtDeliveryEvt entity,
			SingularAttribute<PrcmtDeliveryEvt, ?>[] attributes) {
		return repository.count(entity, attributes);
	}

	public List<PrcmtDeliveryEvt> findByLike(PrcmtDeliveryEvt entity,
			int start, int max,
			SingularAttribute<PrcmtDeliveryEvt, ?>[] attributes) {
		return repository.findByLike(entity, start, max, attributes);
	}

	public Long countByLike(PrcmtDeliveryEvt entity,
			SingularAttribute<PrcmtDeliveryEvt, ?>[] attributes) {
