...
public class SecTerminalEJB 
{
   ...
   public List<SecTerminal> findBy(SecTerminal entity, int start, int max, SingularAttribute<SecTerminal, ?>[] attributes)
   {
      return repository.findBy(entity, start, max, attributes);
   }

   public Long countBy(SecTerminal entity, SingularAttribute<SecTerminal, ?>[] attributes)
   {
      return repository.count(entity, attributes);
   }

   public List<SecTerminal> findByLike(SecTerminal entity, int start, int max, SingularAttribute<SecTerminal, ?>[] attributes)
   {
      return repository.findByLike(entity, start, max, attributes);
   }

   public Long countByLike(SecTerminal entity, SingularAttribute<SecTerminal, ?>[] attributes)
   {
