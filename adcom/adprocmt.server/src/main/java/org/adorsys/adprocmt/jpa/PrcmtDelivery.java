...
public class PrcmtDelivery extends AbstractMvmtData {

	private static final long serialVersionUID = 6475701807535630315L;
	...
	@NotNull
	private ProcmtDlvryStatus dlvryStatus;
	...
	public ProcmtDlvryStatus getDlvryStatus() {
		return this.dlvryStatus;
	}

	public void setDlvryStatus(final ProcmtDlvryStatus dlvryStatus) {
