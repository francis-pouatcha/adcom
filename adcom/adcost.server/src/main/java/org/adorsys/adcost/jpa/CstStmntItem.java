...
public class CstStmntItem extends AbstractIdentifData {
	...
	private AmtOrPct rebateType = AmtOrPct.PERCENT;
	...
	@NotNull
	@Enumerated(EnumType.STRING)
	private AmtOrPct vatType = AmtOrPct.PERCENT;
	...
	public void evlte() {
		...
		if(AmtOrPct.PERCENT==rebateType){
	...
	public AmtOrPct getVatType() {
		return vatType;
	}

	public void setVatType(AmtOrPct vatType) {
